...
if backbone == "mobilenet_v2":
    ...
    from models.ssd_vgg19 import get_model, init_model
elif backbone =="vgg16":
    from models.ssd_vgg16 import get_model, init_model
elif backbone =="efficientnetb1":
    from models.ssd_efficientnetb1 import get_model, init_model
elif backbone =="densenet":
    from models.ssd_densenet import get_model, init_model
#
